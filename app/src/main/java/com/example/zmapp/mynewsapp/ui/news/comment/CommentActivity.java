...
import com.example.mylibrary.part.SimpleVideoPlayer;
import com.example.zmapp.mynewsapp.R;
import com.example.zmapp.mynewsapp.UserManager;
import com.example.zmapp.mynewsapp.bombapi.BombClient;
import com.example.zmapp.mynewsapp.bombapi.NewsApi;
import com.example.zmapp.mynewsapp.bombapi.entity.NewsEntity;
import com.example.zmapp.mynewsapp.bombapi.result.CollectResult;
...
public class CommentActivity extends AppCompatActivity {
    ...
    private Callback<CollectResult> callback = new Callback<CollectResult>() {
        ...
        public void onResponse(Call<CollectResult> call, Response<CollectResult> response) {
            ...
            if (result.isSuccess()){
                Toast.makeText(CommentActivity.this, R.string.like_success, Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(CommentActivity.this, R.string.like_failure + result.getError(), Toast.LENGTH_SHORT).show();
            }
        }
